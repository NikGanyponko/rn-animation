...
const snapX = new Value(0);
const snapY = new Value(0);

const withDecay = (value, state, velocity, offset, snapPoint) => {
...
const DecayAnimation = () => {
  ...
  const translateX = withDecay(translationX, state, velocityX, offsetX, snapX);
  const translateY = withDecay(translationY, state, velocityY, offsetY, snapY);
